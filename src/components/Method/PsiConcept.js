  ...
  return (
    <div ref={ref}>
      <h3 className="font-bold text-2xl">
        {" "}
        Concept of Bureaucratic Success Index( ψ )
      </h3>
      ...
      <ul className="list-disc ml-5 space-y-2">
        ...
        <li className="text-base">
          ...
          Bureaucratic Success Index (ψ). Due to r=1 being the highest grade and
          18 the lowest, we actually sum 19-r so that the larger the ψ the
          larger the success, and also since the bureaucrats are not mentioned
          at a universally fixed interval, in practice we take the area under
          the curve (AUC) that joins grades of the bureaucrats at the time of
          appearance.
        </li>
      </ul>
      <TCS id="tcs" />
