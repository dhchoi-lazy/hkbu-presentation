      ...
      tl.current
        .from(
          "#title",
          {
            text: {
              value:
                "Quantifying Historical Success: Digital Prosopography and the Bureaucratic Success Index",
              delimiter: " ",
            },
    ...
    >
      ...
      >
        <span style={{ backgroundColor: "#ebe4f5" }}>
          Quantifying Historical Success: Digital Prosopography and the
          Bureaucratic Success Index
        </span>
      </h1>
      <h2
        id="author"
